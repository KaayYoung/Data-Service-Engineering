...
if __name__ == '__main__':
    ...
    # df_names = df_names[df_names['count'] > 15]
    #sample = df_names.sample(n=30, random_state=20)
    ...
    print(pred_y)
    print(df_validation.rating)
    print(accuracy_score(df_validation.rating, pred_y))
    print(recall_score(df_validation.rating, pred_y, average='macro'))
    print(precision_score(df_validation.rating, pred_y, average='macro'))
