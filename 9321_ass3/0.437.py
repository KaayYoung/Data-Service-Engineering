...
if __name__ == '__main__':
    ...
    names_list = list(actors_mean_revenue.nlargest(15, 'mean_revenue')['actor'])
    ...
    names_list = list(directors_mean_revenue.nlargest(15, 'mean_revenue')['director'])
    ...
    names_list = list(companies_mean_revenue.nlargest(14, 'mean_revenue')['company'])
